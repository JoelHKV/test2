...
stacknHide([], 1, ['infoboard3', 'infoboard2', 'closemap', 'stationdetails', 'map-container'])
...
function showtrip(thistrip) {

   
    var dep_loc = [stationdata[thistrip["did"]]["y"], stationdata[thistrip["did"]]["x"]]
    var ret_loc = [stationdata[thistrip["rid"]]["y"], stationdata[thistrip["rid"]]["x"]]

    alert(dep_loc + ' ' + ret_loc)



    let temphtml = 'From: ' + stationdata[thistrip["did"]][name] + '<BR>To: '
    temphtml += stationdata[thistrip["rid"]][name] + '<BR>'
    temphtml += 'Dist: ' + thistrip["dis"] + ' km Time: ' + thistrip["time"] + ' min'
