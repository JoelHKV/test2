...
var placeitems = [['stationvstrip', 5, 1, 35, 10],
    ['stationvstrip2', 45, 1, 35, 10],
    ['menu', 10, 30, 70, 70],
    ...
    ['goUp', 88, 36, 10, 10],
    ['scrollUp', 88, 48, 10, 10],
    ['currentdate', 88, 60, 10, 10],
    ['scrollDown', 88, 72, 10, 10],
    ['goDown', 88, 84, 10, 10],
    ['stationdetails', 70, 15, 10, 5],
    ['closemap', 70, 25, 10, 5],
    ['backgroundgray', 5, 10, 80, 95],
['language', 88, 10, 6, 6]]
