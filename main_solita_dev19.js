...
function showtrip3data(scroll) {
    ...
    var innerH = '<div class="col col-1e" style="width: 20%; text-align: left;">Datetime</div><div class="col col-1e" style="width: 25%; text-align: left;">Departure:</div><div class="col col-1e" style="width: 25%; text-align: left;">Return:</div><div class="col col-1e" style="width: 10%; text-align: left;">Dist. in km</div><div class="col col-1e" style="width: 10%; text-align: left;">Dur. (min)</div>'
    document.getElementById("menutitle").innerHTML = innerH
