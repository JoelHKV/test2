...
//let generatedHTML = '<p>This is the generated HTML</p>';
//let generatedHTML = '<button id="generatedButton">Click Me</button>';
let generatedHTML = '<button id="generatedButton" data-param="Herrllo">Click Me</button>';
...
document.getElementById('generatedButton').addEventListener('click', function () {
