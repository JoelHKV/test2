...
document.querySelector(".openpopup").addEventListener("click", () => {
    // let firstDayOfMonth = new Date(currentYear, startMonth, 1);
    //  let thisDayOfWeek = firstDayOfMonth.getDay() || 7;
    ...
    //  calendardates.push(currentDay + '.' + (1 + currentMonth) + '.' + currentYear + '.' + thisDayOfWeek)
    //    currentDay++
    //    thisDayOfWeek++
    //     if (thisDayOfWeek === 8) { thisDayOfWeek = 1 };



   // }
    //alert(calendardates.length
   // for (let i = 0; i < 3; i++) {
   //     let thisdate = calendardates[i].split('.')
       // alert(thisdate[2])
  // }
